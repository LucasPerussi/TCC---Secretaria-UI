...
(function (window, document, $) {
  ...
  var assetPath = '../../html/layout/app-assets/';

  // var assetPath = '../layout/app-assets/';
  // var assetPath = '../../Support/layout/app-assets/';
      ...
      if (value != '') {
        ...
        var $startList = '',
          ...
          $pageList =
            ...
            '<a href="#">' +
            '<h6 class="section-label mt-75 mb-0">Resultados para sua pesquisa</h6>' +
            '</a>' +
            '</li>',
          $activeItemClass = '',
          $bookmarkIcon = '',
        ...
        // $.getJSON(assetPath + 'data/listItems.php', function (data) {
        // $.getJSON(assetPath + 'data/' + $filename + '.json', function (data) {


        $.getJSON("https://wejourney.com.br/action/searchResults", function (data) {

        // $.getJSON("http://localhost/Support/action/searchResults", function (data) {
