        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-header row">
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb ps-0">
                        <li class="breadcrumb-item"><a href="<?= Config::BASE_URL ?>news-board">Mural</a></li>
                        <li class="breadcrumb-item active"><?= htmlspecialchars($mural["titulo"]) ?></li>
                    </ol>
                </div>
            </div>
            <div class="content-body">
                ...
                <?php if (!isset($mural['error'])) { ?>
                    <h1 style="font-weight:500; margin-bottom:5px; "><?= htmlspecialchars($mural["titulo"]) ?> </h1>
                    ...
                    <p style="font-size:11px;">
                        ...
                        <span class="badge ms-1rounded-pill bg-light-<?= $mural["visivel"] == 1 ? "success" : "danger" ?>">
                            <?= $mural["visivel"] == 1 ? "Visível" : "Oculto" ?>
                        </span>
                    </p>
                    <br />
                    <div class="card p-1">
                        <h6><?= nl2br(htmlspecialchars($mural["descricao"])) ?></h6>
                    </div>
