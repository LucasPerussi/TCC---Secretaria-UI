...
<head>
    ...
    <title>Portal Servidor UFPR</title>
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="">
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper container-xxl p-0">
            ...
            <div class="content-body">
                <h1 style="font-weight:500; ">Portal Servidor </h1>
                <br />
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-12">
                        <div class="card options" style="padding:20px; ">
                            ...
                            <a href="<?= Config::BASE_URL ?>pending-formative-hours" class="btn secondaryButton" style="padding:15px;width:100%;margin-bottom:15px;">Horas Formativas Pendentes</a>
                    ...
                    <div class="col-md-8 col-sm-12">
                        ...
                        <br />
                        <div class="card p-1">
                            <?php if ((!isset($myServerRequests["error"])) || (empty($allRequestsWithoutServer))) { ?>
                                <?php foreach ($myServerRequests as $request) { ?>
                        ...
                        <h2>Chamados sem Supervisão </h2>
                        <h6>Estes chamados ainda não foram aceitos por um servidor</h6>
                        <br />
                        <div class="card p-1">
                            <?php if ((!isset($allRequestsWithoutServer["error"])) || (empty($allRequestsWithoutServer))) { ?>
                                <?php foreach ($allRequestsWithoutServer as $request) { ?>
                                    <div class="card p-1 mb-0" id="bodyRequestDash" style="margin-bottom:10px !important;">
                                        <h5 style="font-weight:bold !important;"><?= $request["numero"] . " - " . $request["titulo"] ?> <a onclick="addoptRequest(<?= $request['id'] ?>, '<?= $request['identificador'] ?>')" style="float:right; font-size:11px;padding:7px;" class="btn btn-dark"><i class="bi bi-person-fill-down"></i> Adotar Chamado</a></h5>
    ...
    <script>
        function addoptRequest(RequestId, requestIdentifier){
            axios.post('<?= Config::BASE_ACTION_URL ?>/addopt-request/' + RequestId, true)
            .then(function(response) {
                console.log(response)
                if (response.data.status != 200) {
                    throw response.data;
                } else {
                    window.location.href = "<?= Config::BASE_URL ?>request/" + requestIdentifier
                }
            })
