                        ...
                        <div class="auth-inner row m-0">
                            ...
                            <div class="d-none d-lg-flex col-lg-8 align-items-center p-0">
                                <div class="w-100 d-lg-flex align-items-center justify-content-center px-0">
                                    ...
                                    <video playsinline class="auth-sidebar-video" autoplay loop muted style="width:100% !important;height: 100vh !important; left:-150px !important; top:0px !important; margin:0px !important; position:fixed; z-index:0 !important" src="<?= Config::BASE_URL ?>src/img/banner-login.mp4">
                                    </video>
                            ...
                            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5 p-2" id="login-form" style="z-index:1 !important; ">
                                ...
                                <form id="register-form" class="auth-register-form mt-2" >
                                    ...
                                    <img src="https://wetalkit.com.br/suporte/src/img/logo/logo-preto.svg"  id="logoParaBranco" style="margin-top:10%; margin-left:40%; width:20%  " >
                                    <img src="https://wetalkit.com.br/suporte/src/img/logo/logo-branco.svg"  id="logoParaDark" hidden style="margin-top:10%; margin-left:40%; width:20%  " >
                                </a>
