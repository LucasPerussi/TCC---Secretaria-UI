                    ...
                    <div class="content-wrapper container-xxl p-0">
                        ...
                        <div class="content-body">
                            ...
                            <?php if (($_SESSION["user_role"] == 2) && ((isset($_SESSION["pending-users"])) && ($_SESSION["pending-users"] == "true"))) : ?>
                                <a href="<?= Config::BASE_URL . 'pending-users' ?>">
                                    <div class="card " style="padding:20px;background-color:#fa657b !important;">
                                        <h4 style="color:#001011 !important; font-weight:bold !important;">Usuários pendentes de aprovação!</h4>
                                        <span style="color:#001011 !important;">Existem usuários aguardando aprovação para acessar o tenant de sua empresa. Verifique!</span>
                                    </div>
                                </a>
                            <?php endif; ?>
                            ...
                            <div class="row kb-search-content-info match-height">
                                ...
                                <?php if ($preferences["logo_emp"] > 0) : ?>
                                    <div class="col-md-<?= $preferences["logo_emp"] * 4 ?> col-sm-6 col-12 kb-search-content">
                                        <div class="card" style="    
                                                        ...
                                                        align-items: center;">
                                            <img style="width:60%; max-width:400px; justify-content:center;text-align:center; padding:30px;" src="<?= $myCompany["com_logo"] ?>" alt="us">
                                        ...
                                        <?php if ($sales != "[]") { ?>
                                            <div class="card" style="padding:20px;">
                                                <h3 style="font-weight: 700 !important;">
                                                    Últimas Compras <a href="<?= Config::BASE_URL . 'company-sales' ?>" class="btn btn-outline-dark " style="float:right; font-size:12px; padding:7px !important;">Ver Todas</a></h3>
                                                <br />
                                                <?php $cont = 0; ?>
                                                <?php foreach (json_decode($sales) as $sale) { ?>
                                                    ...
                                                    <?php if ($cont == 1) { ?>
                                                        ...
                                                        <a target="_blank" href="<?= Config::BASE_URL . 'company-sale/' . $sale->deal . '?sale=' . $sale->name ?>">
                                                            ...
                                                            <div class="card" style="padding:20px; padding-bottom:20px; margin-bottom:10px;" id="bodyRequestDash">
                                ...
                                <?php if ($preferences["cha_wet"] > 0) : ?>
                                    <div class="col-md-<?= $preferences["cha_wet"] * 4 ?> col-sm-6 col-12 ">
                                        <div class="card " style="padding:20px;  min-height:280px !important;overflow-y:auto; padding-bottom:0px; ">
                                ...
                                <?php if ($preferences["avs_inv"] > 0) : ?>
                                    ...
                                    <div class="col-md-4 col-sm-12 col-12 ">
                                        <div class="card" style="padding:20px; ">
                                            <h3 style="font-weight: 700 !important;">
                                                Inventário <a href="<?= Config::BASE_URL . 'inventory-dashboard' ?>" class="btn btn-outline-dark " style="float:right; font-size:12px; padding:7px !important;">Painel</a>
                                            </h3>
                                            <p class=" mb-0" style="color:gray;">
                                                Gerencie seus ativos e salas</p>
                                            <br />
                                            <div class="card" id="bodyRequestDash" style="border-radius:20px; padding:20px;padding-bottom:20px;margin-bottom:10px !important;">
                                                <form method="GET" action="<?= Config::BASE_URL . 'item-management' ?>">
                                                    <div class="" style="margin: 0px !important;padding:0px !important;">
                                                        <h6>Buscar / Cadastrar Serial Number</h6>
                                                        <input type="text" style="text-align:center;border-radius:20px; font-size:15px;font-weight: 600 !important;width:100%; margin-top:10px;" name="serial-number" <?php if (isset($_GET["serial-number"])) {
                                                                                                                                                                                                                            echo "value='" . $_GET["serial-number"] . "'";
                                                                                                                                                                                                                        } ?> class="form-control" placeholder="XXXXXXXXXXXXXXXXXX"><span><i class="bi bi-search" style=" float:right;position:absolute; margin-left:15px; margin-top:-29px;"></i></span>
                                                    </div>
                                                </form>

                                            </div>
                                            <br />
                                            <h5 style="font-weight: bold !important;">Alertas</h5>
                                            <br />
                                            <div class="card" id="bodyRequestDash" style="border-radius:20px; padding:20px;padding-bottom:0px;margin-bottom:10px !important;">
                                                <?php $contAlerts = 0; ?>
                                                <h6>
                                                    <?php if (!isset($dashboardRooms["error"])) : ?>
                                                        <?php if ($dashboardRooms["hasRoomWithoutInventory"] > 0) : ?>
                                                            <?php $contAlerts++ ?>
                                                            <span class="badge rounded-pill badge-light-danger mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Existem salas sem equipamentos alocados"><i class="bi bi-camera"></i> Salas sem Equipamento</span>
                                                        <?php endif; ?>
                                                        <?php if ($dashboardRooms["hasRoomWithoutPicture"] > 0) : ?>
                                                            <?php $contAlerts++ ?>
                                                            <span class="badge rounded-pill badge-light-warning mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Salas sem fotografia"><i class="bi bi-images"></i> Salas sem fotos</span>
                                                        <?php endif; ?>
                                                        <?php if ($dashboardRooms["totalRoomsTickets"] > 0) : ?>
                                                            <?php $contAlerts++ ?>
                                                            <span class="badge rounded-pill badge-light-warning mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Salas com chamados em aberto"> <i class="bi bi-exclamation-triangle"></i> Salas com problema </span>
                                                        <?php endif; ?>
                                                    <?php else : ?>
                                                        <?php $contAlerts++ ?>
                                                        <span class="badge rounded-pill badge-light-danger mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Cadastre sua sala para gerenciar seus inventários e muito mais!"><i class="bi bi-person-vcard"></i>Nenhuma sala cadastrada</span>
                                                    <?php endif; ?>
                                                    <?php if (!isset($dashboard["error"])) : ?>
                                                        <?php if ($dashboard["hasNoWarrantyItems"] > 0) : ?>
                                                            <?php $contAlerts++ ?>
                                                            <span class="badge rounded-pill badge-light-danger mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Equipamentos sem garantia"><i class="bi bi-arrow-repeat"></i> Fim de garantia</span>
                                                        <?php endif; ?>
                                                        <?php if ($dashboard["hasDeadItems"] > 0) : ?>
                                                            <?php $contAlerts++ ?>
                                                            <span class="badge rounded-pill badge-light-danger mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Equipamentos fora de ciclo de vida"> <i class="bi bi-star"></i> Fim de Ciclo de Vida</span>
                                                        <?php endif; ?>
                                                        <?php if ($dashboard["itemsExpiredBackup"] > 0) : ?>
                                                            <?php $contAlerts++ ?>
                                                            <span class="badge rounded-pill badge-light-danger mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Equipamentos com backup expirados"><i class="bi bi-calendar2-x"></i> Backup de equipamento expirado</span>
                                                        <?php endif; ?>
                                                        <?php if ($dashboard["hasItemsWithoutSerial"] > 0) : ?>
                                                            <?php $contAlerts++ ?>
                                                            <span class="badge rounded-pill badge-light-danger mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Equipamentos sem serial number"><i class="bi bi-key-fill"></i> S/N Pendentes</span>
                                                        <?php endif; ?>
                                                    <?php else : ?>
                                                        <?php $contAlerts++ ?>
                                                        <span class="badge rounded-pill badge-light-danger mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Cadastre seus ativos para gerenciá-los"><i class="bi bi-person-vcard"></i>Nenhum ativo cadastrado</span>
                                                    <?php endif; ?>

                                                    <?php if ($contAlerts == 0) : ?>
                                                        <span class="badge rounded-pill badge-light-success mb-1" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Cadastre seus ativos para gerenciá-los">Tudo parece certo! :)</span>
                                                    <?php endif; ?>
                                                </h6>
                                            </div>
                                        </div>
