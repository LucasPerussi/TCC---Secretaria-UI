...
<div class="swiper-container" style="overflow:hidden; margin-bottom:15px; max-height: 40px !important;">
    <div class="swiper-wrapper">
        <div class="swiper-slide" style="max-width:110px !important;">
            <a class="nav-link active" style="padding:8px; margin-right:10px;" id="settings-section-btn" href="#settings-section">
                <i data-feather="user" class="font-medium-1 me-50"></i>
                <span class="fw-bold"><?= __("configuracoes_nav.conta") ?></span>
            </a>
        </div>
        <div class="swiper-slide" style="max-width:170px !important; <?php if (($_SESSION["allowBC"] == 0) || ($_SESSION["user_role"] == 5)) {echo 'display:none;';} ; ?>">
            <a class="nav-link" style="padding:8px; margin-right:10px;" id="business-card-section-btn" href="#business-card-section">
        ...
        <div class="swiper-slide" style="max-width:140px !important;">
            <a class="nav-link" style="padding:8px; margin-right:10px;" id="security-section-btn" href="#security-section">
                <i data-feather="lock" class="font-medium-1 me-50"></i>
                <span class="fw-bold"><?= __("configuracoes_nav.seguranca") ?></span>
            </a>
        </div>

        <div class="swiper-slide" style="min-width:170px !important; max-width:200px !important; display:none;">
            <a class="nav-link" style="padding:8px; margin-right:10px;" id="logins-section-btn" href="#logins-section">
                <i data-feather="map-pin" class="font-medium-1 me-50"></i>
                <span class="fw-bold"><?= __("configuracoes_nav.acessos") ?></span>
            </a>
        </div>

        <div class="swiper-slide" style="min-width:170px !important; max-width:200px !important; <?= ($_SESSION["user_role"] == 5) ? 'display:none;' : ''; ?>">
            <a class="nav-link" style="padding:8px; margin-right:10px;" id="requests-section-btn" href="#requests-section">
